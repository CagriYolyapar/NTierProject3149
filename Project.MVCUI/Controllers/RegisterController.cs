...
namespace Project.MVCUI.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public ActionResult RegisterNow(AppUser appUser,UserProfile userProfile)
        {
            ...
            string gonderilecekEmail = "Tebrikler... Hesabınız olusturulmustur...Hesabınızı aktive etmek icin https://localhost:44347/Register/Activation/"+appUser.ActivationCode+" linkine tıklayabilirsiniz";
