...
namespace Project.DAL.StrategyPattern
{
    ...
    //Bogus kütüphanesi, bize hazır Data sunan bir kütüphanedir...
    public class MyInit:CreateDatabaseIfNotExists<MyContext>
    {
        protected override void Seed(MyContext context)
        {
            ...
            for (int i = 2; i < 12; i++)
            {
                ...
                up.ID = i; //Birebir ilişki oldugundan dolayı üst tarafa olusturulan AppUser'ların ID'leri ile buraları eşleşmeli.. O  yüzden döngünün iterasyonunu 2'den baslattık...
